                ...
                <div class="splide__track">
                    <ul class="splide__list">
                        <li class="splide__slide">
                            <div id="conten" class="group handphone:ml-[15%] tablet:ml-10 laptop:ml-10">
                                <div class="w-72">
                        ...
                        <li class="splide__slide">
                            <div id="aso" class="group handphone:ml-[15%] tablet:ml-5 laptop:ml-10">
                                <div class="w-72">
                        ...
                        <li class="splide__slide">
                            <div id="conten" class="group handphone:ml-[15%] tablet:ml-5 laptop:ml-10">
                                <div class="w-72">
                                    <img src="img/silver.jpg" class="relative" alt="">
                                    <img src="img/silver2.jpg" class="relative -mt-[100%] group-hover:animate-fade"
                                        alt="">
