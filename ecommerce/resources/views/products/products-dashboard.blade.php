<x-app-layout>
    ...
    <div>
        ...
        <div class="container max-w-full h-full">
            ...
            <div class="grid gap-3 justify-center self-center mx-3 grid-cols-2 text-center font-mono tablet:grid-cols-3 laptop:grid-cols-4 lg:grid-cols-5">
                <div class="">
                    <a href="#">
                    <img src="img/silver.jpg" class="" alt="Necklace">
                    <p>Blight Pendant</p>
                    <p class="text-yellow-700 border-b-1 w-1/2 ml-[25%] border-yellow-600">$20.50</p>
                    </a>
                </div> 
                <div class="">
                    <a href="#">
                        <img src="img/silver2.jpg" class="" alt="Necklace">
                        <p>Blindness Pendant</p>
                        <p class="text-yellow-700 border-b-1 w-1/2 ml-[25%] border-yellow-600">$20.50</p>
                    </a>
                </div>
                <div class="">
                    <a href="#">
                    <img src="img/silver3.jpg" class="" alt="Necklace">
                    <p>Blight Pendant</p>
                    <p class="text-yellow-700 border-b-1 w-1/2 ml-[25%] border-yellow-600">$20.50</p>
                    </a>
                </div> 
                <div class="">
                    <a href="#">
                        <img src="img/silver4.jpg" class="" alt="Necklace">
                        <p>Blindness Pendant</p>
                        <p class="text-yellow-700 border-b-1 w-1/2 ml-[25%] border-yellow-600">$20.50</p>
                    </a>
                </div>
        ...
        <div class="container max-w-full h-full">
            <div class="justify-center text-center">
                <h1 class="mt-4 font-serif"><a href="products?code=aeon">Asoka Collection</a></h1>
                <p class="bg-black/10 mt-3 h-[0.10rem] ml-[25%] w-1/2 mb-5"></p>
            </div>
        </div>
        <?php 
