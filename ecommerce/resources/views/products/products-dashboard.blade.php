<x-app-layout>
    ...
    <div class="container max-w-full h-full">
        <div class="justify-center text-center">
            ...
            <p class="bg-black/50 mt-3 h-[0.10rem] ml-[25%] w-1/2 mb-5"></p>
            <div
        ...
        <div
            ...
            <div id="bhinek" class="group handphone:mb-5 tablet:ml-0 laptop:ml-10 xl:ml-0 lg:w-fit">
                <div class="w-72">
                    ...
                    <img src="img/asoka8.jpg" class="relative -mt-[100%] group-hover:animate-fade" alt="">
            ...
            <div id="bati"
                ...
                <div class="w-72">
                    ...
                    <img src="img/asoka5.jpg" class="relative -mt-[100%] group-hover:animate-fade" alt="">
            ...
            <div id="batu" class="group tablet:ml-5 laptop:ml-10 xl:ml-0 tablet:hidden xl:flex flex-col">
                <div class="w-72">
                    ...
                    <img src="img/asoka7.jpg" class="relative -mt-[100%] group-hover:animate-fade" alt="">
    ...
    <div>
        <h1 class="text-center mt-3">AEON Collection</h1>
        <div
