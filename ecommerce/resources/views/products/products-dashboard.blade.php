        ...
        <div>
            ...
            <div class="max-w-md w-3/4 relative left-[25%] grid grid-cols-1 tablet:grid tablet:grid-cols-2 tablet:left-[10%] tablet:gap-4 tablet:max-w-lg tablet:w-full laptop:max-w-2xl laptop:grid-cols-3 laptop:left-[5%] lg:grid-cols-4 lg:w-full lg:max-w-4xl lg:left-[10%] xl:max-w-5xl">
                <div class="w-2/3 mb-3 tablet:w-full">
                    ...
                    <p class="font-serif text-xl">Stardust Pilar</p> 
                    <p class="font-mono text-end text-lg">$ 102.80</p>
                </div>
                <div class="w-2/3 mb-3 tablet:w-full">
                    <div class="group">
                        <div class="flex flex-row overflow-hidden">
                    ...
                    <p class="font-serif text-xl">Nebula Pilar</p> 
                    <p class="font-mono text-end text-lg">$ 90.80</p>
                </div>
                <div class="w-2/3 mb-3 tablet:w-full">
                    <div class="group">
                        <div class="flex flex-row overflow-hidden">
                    ...
                    <p class="font-serif text-xl">Vortex Pilar</p> 
                    <p class="font-mono text-end text-lg">$ 50.80</p>
                </div>
                <div class="w-2/3 mb-3 tablet:w-full">
                    <div class="group">
                        <div class="flex flex-row overflow-hidden">
                    ...
                    <p class="font-serif text-xl">Flare Pilar</p> 
                    <p class="font-mono text-end text-lg">$ 102.80</p>
                </div>
                <div class="w-2/3 mb-3 tablet:w-full">
                    <div class="group">
                    ...
                    <p class="font-serif text-xl">Dream Pilar</p> 
                    <p class="font-mono text-end text-lg">$ 200.80</p>
                </div>
            </div>
        </div>
    </div>
